...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-300 via-indigo-200 to-purple-300 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900">
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p className="text-lg leading-relaxed">
                ...
                end-to-end type safety, automatic API documentation, and
